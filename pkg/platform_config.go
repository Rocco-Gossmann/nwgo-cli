...
var platformMap = map[string]PlatformEnv{
	...
	"darwin_arm64": {
		Download_build: "https://dl.nwjs.io/v0.93.0/nwjs-v0.93.0-osx-arm64.zip",
		BuildCutPath:   "nwjs-v0.93.0-osx-arm64/",

		Download_sdk:         "https://dl.nwjs.io/v0.93.0/nwjs-sdk-v0.93.0-osx-arm64.zip",
		...
		Launch_file:          "nwjs-sdk-v0.93.0-osx-arm64/nwjs.app/Contents/MacOS/nwjs",
	...
	"linux_amd64": {
		Download_build:       "https://dl.nwjs.io/v0.93.0/nwjs-v0.93.0-linux-x64.tar.gz",
		Download_sdk:         "https://dl.nwjs.io/v0.93.0/nwjs-sdk-v0.93.0-linux-x64.tar.gz",
		...
		Launch_file:          "nwjs-sdk-v0.93.0-linux-x64/nw",
		Extractor:            ExtractTarGZ,
		DirSeparator:         "/",
		BackendBinary:        "backend",
		BuildPreRunJS:        `spawn('chmod', [ '+x', './backend' ])`,
		PostBuild:            moveAppToPackage("nwjs-v0.93.0-linux-x64/package.nw"),
	},

	"windows_amd64": {
		Download_build:       "https://dl.nwjs.io/v0.93.0/nwjs-v0.93.0-win-x64.zip",
		Download_sdk:         "https://dl.nwjs.io/v0.93.0/nwjs-sdk-v0.93.0-win-x64.zip",
		...
		Launch_file:          "nwjs-sdk-v0.93.0-win-x64\\nw.exe",
		Extractor:            ExtractZip,
		DirSeparator:         "\\",
		BackendBinary:        "backend.exe",
		BackendBinarySlash:   "\\",
		PostBuild:            moveAppToPackage("nwjs-v0.93.0-win-x64\\package.nw"),
	},
}
...
func MacPostSetup(pe PlatformEnv) {
	exec.Command("xattr", "-cr", "nwjs-sdk-v0.93.0-osx-arm64/nwjs.app").Output()
}
